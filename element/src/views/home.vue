<template>
  ...
  <el-header style="font-size: 12px;background-color:#545c64;border-radius: 12px;">
    <el-row type="flex" justify="space-between">
      <el-col :span="10" style="font-size: 20px;color: #ffd04b">
  <router-link to="/home/hello" style="color: #ffd04b; text-decoration: none;">
    人性化的公司考勤管理系统
  </router-link>
</el-col>
    ...
    <el-menu 
      ...
      >
        <el-submenu index="3">
          ...
          <el-menu-item index="/employer/ChangeInfo">修改个人信息</el-menu-item>
          <el-menu-item index="/employer/ChangePassword">修改密码</el-menu-item>
